...
<div class="col-md-6 col-md-offset-4">
  ...
  <div class="container">
         ...
         <h3><span class="glyphicon glyphicon-pencil"></span> Confirm Details</h3>
				...
				<span style="color:red"><form:input path="UserName"	value="${user.userName}"/></span>
					<br /><br />
									</div>
    </div>
    			<div class="form-group">
				...
				<span style="color:red"><form:input	path="password"	value="${user.password}"/></span>
					<br /><br />
					</div>
    </div>
    	<div class="form-group">
			...
			<label  class="col-md-6 control-label" >confirmPassWord</label>
				<span style="color:red"><form:input  path="confirmPassWord" value="${user.confirmPassWord}"/></span>
					<br /><br />
						</div>
    </div>
...
<div class="col-md-6 col-md-offset-4">
 <div   class="form-group">
					...
					<input name="_eventId_submit" type="submit" value="Confirm Details" class="btn btn-default"/><br />
					 </div>
        </div>
