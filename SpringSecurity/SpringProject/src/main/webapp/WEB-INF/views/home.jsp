...
<meta name="viewport" content="width=device-width, intial-scale=1.0">
  ...
  <body>
  Train ticket Train ticket Train ticket Train ticket Train ticket
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox" >
    <div class="item active"  >
     ...
     <a href="first/WaterHeater"> <img src="<c:url value='/resources/images/IronBox1.jpg'/>" alt="test"  class="img-responsive" alt="Chania" style="width:4000px;height:370px"/> </a>
    </div>

    <div class="item">
    <a href="second">  <img src="<c:url value='/resources/images/cokr1.jpeg'/>" alt="test" class="img-responsive" alt="Chania" style="width:4000px;height:370px"/></a>
    </div>

    <div class="item">
     <a href="third"> <img src="<c:url value='/resources/images/ind3.jpeg'/>" alt="test" class="img-responsive" alt="Chania" style="width:4000px;height:370px"/></a>
    </div>

 
     <div class="item">
    <a href="fourth">  <img src="<c:url value='/resources/images/oven1.jpg'/>" alt="test" class="img-responsive" alt="Chania" style="width:4000px;height:370px"/></a>
    </div>
  </div>
